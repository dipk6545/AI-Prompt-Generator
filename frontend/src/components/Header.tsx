              ...
              {hasSavedKey && !isEditingKey ? (
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="h-10 px-3 bg-violet-600 hover:bg-violet-700 disabled:bg-slate-200 text-white disabled:text-slate-400 text-xs font-semibold rounded-xl transition-colors"
                  >
                    Save
                  </button>
                  {isEditingKey && (
                    <button
                      ...
                      className="h-10 px-3 bg-slate-100 hover:bg-slate-200 text-slate-600 text-xs font-semibold rounded-xl transition-colors"
                    >
                      Cancel
                    </button>
                  )}
