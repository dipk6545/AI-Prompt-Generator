...
export const PromptPanels: React.FC<PromptPanelsProps> = ({
  ...
  return (
    <div className="flex-1 flex flex-col p-6 gap-6 overflow-y-auto min-h-0">
      {/* Error Banner */}
      {errorMsg && (
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-2 gap-6 min-h-0">
        ...
        {/* Left Panel - Input */}
        <div className="flex flex-col bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden group focus-within:ring-2 focus-within:ring-violet-500/10 focus-within:border-violet-500 transition-all min-h-0">
        ...
        {/* Right Panel - Split: Top Analysis, Bottom Output */}
        <div className="flex flex-col gap-6 min-h-0">
          
          {/* Top Panel - Analysis Section */}
          <div className="flex-1 bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden flex flex-col min-h-[350px]">
          ...
          <div className="h-[240px] bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden flex flex-col shrink-0 min-h-0">
            <div className="px-5 py-3.5 border-b border-slate-100 bg-slate-50/50 flex items-center justify-between shrink-0">
              <div className="flex items-center space-x-2">
