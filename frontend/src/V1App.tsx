...
const V1App: React.FC<V1AppProps> = ({ onBackToHome }) => {
  ...
  const handleGenerate = async () => {
    ...
    try {
      // Trigger analysis for UI concurrently
      handleAnalyze();
      ...
      // V1 does not return an optimization report natively, but we set it empty
      setOptimizationReport([]);
